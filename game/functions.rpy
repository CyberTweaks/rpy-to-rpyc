...
init python:
    ...
    def move_to_room(target_room):
        ...
        renpy.hide_screen("hidemarketUI") #map jumps to this function whenever u select a map location, make sure to hide screens here
...
label changeStrength(amount, fromwhere="none"):
    ...
    if fromwhere in boruto_gained_attributes_strength and fromwhere != "none":
        ...
        if strength == 2 and strengthlevel >=9:
            $ strengthlevel = 9
